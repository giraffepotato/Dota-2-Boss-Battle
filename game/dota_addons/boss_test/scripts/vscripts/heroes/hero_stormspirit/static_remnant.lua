...
function static_remnant_init( keys )
	...
	local target = caster:GetAbsOrigin() + RandomVector(math.random(900, 10))
	...
	-- Dummy creation
		...
		local dummy = CreateUnitByName( "npc_dummy_unit", target, false, caster , nil, caster:GetTeamNumber() )
		ability:ApplyDataDrivenModifier( caster, dummy, dummyModifierName, {} )
		
		dummy:SetModel(model_name)
		dummy:SetModelScale(3.4)
